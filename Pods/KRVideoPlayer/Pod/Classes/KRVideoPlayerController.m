...
- (void)fullScreenButtonClick
{
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:KRVideoPlayerControllerFullScreenNoti object:nil];
    }];
}
...
- (void)shrinkScreenButtonClick
{
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:KRVideoPlayerControllerExitFullScreenNoti object:nil];
    }];
}
